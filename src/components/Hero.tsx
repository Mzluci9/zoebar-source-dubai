...
import heroCoffeeGreen from "@/assets/hero-coffee-green.jpg";
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
const slides = [
  {
    ...
    description:
      "We supply specialty-grade Ethiopian green coffee with verified traceability, consistent lot quality, and structured export coordination; built for growing roasters in the UAE and Saudi Arabia.",
    primaryAction: { text: "Request Coffee Specs", href: "/contact" },
    secondaryAction: { text: "Speak with Us", href: "/contact" },
  },
  {
    image: heroCoffeeRoasted,
    title: "Specialty-Grade Beans, Roaster-Ready Quality",
    description:
      "From Yirgacheffe to Sidamo — curated Ethiopian lots with consistent cup profiles, graded and prepared to meet the standards of specialty roasters across the Gulf.",
    primaryAction: { text: "View Our Coffees", href: "/products" },
    secondaryAction: { text: "Speak with Us", href: "/contact" },
  },
  {
    image: heroCoffeeGreen,
    title: "Direct from Ethiopian Farms to Your Roastery",
    description:
      "Transparent sourcing with full traceability from farm to port. Every lot verified, every shipment coordinated — so you can focus on roasting, not logistics.",
    primaryAction: { text: "Request Samples", href: "/contact" },
    secondaryAction: { text: "Speak with Us", href: "/contact" },
  },
];
